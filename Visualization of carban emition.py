...
Original file is located at
    https://colab.research.google.com/drive/1RHsf2Byit0btTL7Z907-Unw9ABXmkx0u
"""
...
File_name = "/content/API_19_DS2_en_csv_v2_4700503.csv"
...
# Show the 'CO2_Emission_Data' DataFrame's first few rows.
CO2_Emission_Data.head()

# print the shape of data.
CO2_Emission_Data.shape

# print the information of data like total no. of columns, total rows, data types etc.
CO2_Emission_Data.info()

# print null values present or not in data.
CO2_Emission_Data.isnull().sum()

# print data into dataframe using describe method.
CO2_Emission_Data.describe().T
...
Data_Extract_for_Arable_land = Data_Extract_for_Arable_land.drop(['Country Code', 'Indicator Name', 'Indicator Code'], axis=1)
...
countries_to_compare = ['Vietnam', 'United States', 'Thailand', 'Turkmenistan', 'Saudi Arabia', 'Nigeria', 'Mexico', 'Canada', 'France', 'Spain']
...
create_line_graph(Data_Extract_from_Arable_land_for_10_countries, countries_to_compare, 'Comparison of Arable land (% of land area) For Different Countries Over the Years', 'Year', 'Arable land (% of land area)', colors)
...
create_pivot_table_with_index_and_values = Data_Extraction_for_electric_power_counsumption.pivot_table(index=['Country Name'], values=['1960', '1965', '1970', '1975', '1980', '1985', '1990', '1995', '2000', '2005', '2010', '2015', '2020'])

# Showing the top 20 country data.
select_data_for_top_20_countries = create_pivot_table_with_index_and_values.head(20)

# Define custom colors for the bars.
custom_colors = ['#FF5733', '#338DFF', '#FFC733', '#33FF57', '#FF33C7', '#33FFC7', '#B533FF', '#9b59b6', '#3498db', '#95a5a6', '#e74c3c', '#34495e', '#2ecc71']

create_bar_graph(select_data_for_top_20_countries, custom_colors, 'Comparison of Electric power consumption (kWh per capita) For Different Countries Over the Years', 'Countries', 'Electric power consumption (kWh per capita)')
